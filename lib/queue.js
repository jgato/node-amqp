...
Queue.prototype._onMethod = function (channel, method, args) {
  ...
  switch (method) {
    ...
    case methods.queueDeclareOk:
      ...
      if (this.connection.queues[this.name] === undefined)
          this.connection.queues[this.name] = {};
      this.connection.queues[this.name][this.channel] = this;
    ...
    case methods.channelClose:
      this.state = "closed";
      this.closeOK();
      this.connection.queueClosed(this.name, this.channel);
